...
# 联接tushare的api接口
read_dir_week = 'D:/Program Files/tdx/vipdoc/sz/sz_rsrs_return_week'
...
for stock_file in szlistfile:
    stock_list = pd.read_csv(read_dir_week + os.sep + stock_file, usecols=['ts_code', 'trade_date', 'high', 'low', 'close', 'beta',
